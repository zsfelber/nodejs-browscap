...
```
Searching algorithm is quite efficient. Current Browscap pattern database consists of 446k records, and any requested sample is being matched against each. It finds all valid instances, no partially sufficient heuristics applied, no restrictions of greedy matching, first record only, etc. Still, on my desktop env:
